...
const baseMessagesResponse = {
  ...
  messages: [
    {
      ...
      sender: { id: 'user-finder', name: 'Finder', username: 'finder', email: 'f@t.com', avatar_url: null, createdAt: '', updatedAt: '' },
    ...
    },
    {
      ...
      sender: { id: 'user-owner', name: 'Owner', username: 'owner', email: 'o@t.com', avatar_url: null, createdAt: '', updatedAt: '' },
  ...
  claim: {
    ...
    claimant: { id: 'user-finder', name: 'Finder', username: 'finder', email: 'f@t.com', avatar_url: null, createdAt: '', updatedAt: '' },
    owner: { id: 'user-owner', name: 'Owner', username: 'owner', email: 'o@t.com', avatar_url: null, createdAt: '', updatedAt: '' },
  },
};
